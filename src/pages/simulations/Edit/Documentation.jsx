...
export function Documentation() {
	return <Page title="Allgemeine Dokumentation" backButton={`/create`}>
		...
		<p>Ereignisse sind Situationen, in denen Sie den normalen Ablauf der Simulation gewaltsam unterbrechen. Ereignisse haben immer eine Bedingung, die sie auslöst, wie &quot;<Code>hp &lt; 0</Code>&quot;. (Dies wird beim Verlassen einer Seite überprüft, nicht beim Betreten einer Seite.) Die Ereignisse haben auch eine Seite, zu der gesprungen wird, wenn sie eintreten. Dies könnte zum Beispiel eine Seite sein, die anzeigt &quot;Du bist gestorben&quot; oder was auch immer man sich vorstellen kann. Jedes Ereignis kann nur einmal während der gesamten Simulation ausgelöst werden.</p>
