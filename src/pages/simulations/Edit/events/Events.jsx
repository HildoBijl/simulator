...
function EventsIntroduction({ addEvent }) {
	return <>
		...
		<p>Ein Ereignis hat eine Bedingung (Auslöser) wie &quot;geld &lt; 20&quot;. Wenn (nach einer Update) diese Bedingung erfüllt ist, wird dem Benutzer eine bestimmte neue Frage/ein bestimmtes Szenario angezeigt, unabhängig davon, was vorher passiert ist. (Wenn mehrere Ereignisse eintreten, wird eines davon willkürlich ausgewählt.)</p>
		<FormPart>
