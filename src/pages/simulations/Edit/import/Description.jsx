...
export function Description() {
	return <>
		...
		<p>Laden Sie dazu Ihre aktuelle Simulation als Excel-Datei herunter. (Oder laden Sie für leere Simulationen die <Link to="/Simulationsvorlage.xlsx" target="_blank">Vorlage</Link> herunter.) Ändern Sie den Inhalt dieser Datei. Laden Sie sie dann erneut hoch. Wir überprüfen zunächst den Inhalt der Excel-Datei. Wenn alles in Ordnung ist, dann wird nach Ihrer Bestätigung der Inhalt der Excel-Datei die bestehende Simulation überschreiben.</p>
