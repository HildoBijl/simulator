...
export function StartPage({ simulation, start }) {
	return <Page title={simulation.title || '[Simulationstitel fehlt]'}>
		...
		{simulation.questions ? <Button variant="contained" sx={{ margin: '1rem 0' }} onClick={() => start()}>Simulation anfangen</Button> : <p>Diese Simulation kann noch nicht gespielt werden: Es sind noch keine Fragen vorhanden.</p>}
	</Page>
}
