...
export function StartPage({ simulation, start }) {
	...
	return <Page title={simulation.title || '[Simulationstitel fehlt]'} showLogo="right">
		...
		{simulation.questions ? <Button variant="contained" sx={{ margin: '0 0 1rem 0' }} onClick={() => start(isOwner)}>Anfangen</Button> : <p>Diese Simulation kann noch nicht gespielt werden: Es sind noch keine Fragen vorhanden.</p>}
	</Page>
}
